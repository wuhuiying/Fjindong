package one.bw.com.jingdong.shouye.view;
...
public class MyPaoMaView extends TextView {
    ...
    public void setOnClickLitener(MyPaoMaView.onClickLitener onClickLitener) {
    ...
    public MyPaoMaView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        ...
        mPaintFront.setTextSize(25);


        mPaintBack = new Paint();
        mPaintBack.setAntiAlias(true);
        mPaintBack.setDither(true);
        mPaintBack.setTextSize(25);
